              ...
              <div className='w-full flex flex-col    '>
                  <div className='flex space-x-8 '>
                    <div className='flex flex-col items-center justify-start w-[1px]  bg-line h-32   '>
                      <div className='p-3  bg-grey-800 rounded-xl -my-1 flex justify-center items-center'>
                      <svg stroke="currentColor" fill="#617CDB" strokeidth="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0zm10 5h4v2h-4zm0 0h4v2h-4z"></path><path d="M10 16v-1H3.01L3 19c0 1.11.89 2 2 2h14c1.11 0 2-.89 2-2v-4h-7v1h-4zm10-9h-4.01V5l-2-2h-4l-2 2v2H4c-1.1 0-2 .9-2 2v3c0 1.11.89 2 2 2h6v-2h4v2h6c1.1 0 2-.9 2-2V9c0-1.1-.9-2-2-2zm-6 0h-4V5h4v2z"></path></svg>
                      </div>
                      </div>                    
                      <div >
              ...
              {/* end  Experience  */}
                  ...
                  <div className='flex space-x-8'>
                    <div className='flex flex-col items-center justify-start w-[1px]  bg-line h-24   '>
                      <div className='p-3  bg-grey-800 rounded-xl -my-1 flex justify-center items-center'>
                        <svg stroke="currentColor" fill="#617CDB  " strokeidth="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path fill="none" d="M0 0h24v24H0z"></path><path d="M9 21c0 .5.4 1 1 1h4c.6 0 1-.5 1-1v-1H9v1zm3-19C8.1 2 5 5.1 5 9c0 2.4 1.2 4.5 3 5.7V17c0 .5.4 1 1 1h6c.6 0 1-.5 1-1v-2.3c1.8-1.3 3-3.4 3-5.7 0-3.9-3.1-7-7-7z"></path></svg>
                      </div>
                      </div>                    
                      <div >
